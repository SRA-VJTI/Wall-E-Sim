        ...
        */
        ...
        while (1) {
            ...
            */
            ...
            if (all_black_flag == 1){
                cout << "All Black Condition, Turning Right " << endl;
                all_black_counter = callTurn(clientID,sensorHandle,n,leftmotorHandle,rightmotorHandle,all_black_flag,all_black_counter, sensorValue, ALL_BLACK);
                // Condition for Stop //
                if (all_black_counter == STOP){
                    cout << "Stopping" << endl;
                    break;
                }
                cout << "All Black condition ends, resuming " << endl;
            }
            //----------------------xx---------------------------//
            if (sensorValue[1]>sensorValue[0] and sensorValue[2]>sensorValue[0]){
                if (sensorValue[1] > TURN_MARGIN and sensorValue[2] > TURN_MARGIN){
                    ...
                    cout<< "Done Turning Left, resuming " << endl;
                }
            }

            if (sensorValue[1]>sensorValue[2] and sensorValue[0]>sensorValue[2]){
                if (sensorValue[1] > TURN_MARGIN and sensorValue[0] > TURN_MARGIN){
                    cout << "Turning Right " << endl;
                    all_black_counter = callTurn(clientID,sensorHandle,n,leftmotorHandle,rightmotorHandle,all_black_flag,all_black_counter, sensorValue, RIGHT);
                    cout<< "Done Turning Right , resuming " << endl;
                }
            }



            if ((sensorValue[1]<WHITE_MARGIN and sensorValue[0]<WHITE_MARGIN) and sensorValue[2]<WHITE_MARGIN){
                cout << "Out of Line, reversing " << endl;
                all_black_counter = callTurn(clientID,sensorHandle,n,leftmotorHandle,rightmotorHandle,all_black_flag,all_black_counter, sensorValue, REVERSE);
                cout <<  "Done reversing, resuming " << endl;
            }
